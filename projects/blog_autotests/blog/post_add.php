...
// обробка форми додавання запису
...
<main class="main-form">
    ...
    <form method="post" name="post" action="" class="form" id="form-post" enctype="multipart/form-data">
        <ul>
            ...
            <li>
                <input type="text" minlength="2" maxlength="128" value="<?= $_POST['title'] ?? '' ?>" name="title" id="form-post-title" required placeholder="Введіть назву запису">
            </li>

            <li><label for="form-post-description">Опис<span>*</span></label></li>
            <li><textarea name="description" id="form-post-description" required placeholder="Введіть опис"><?= $_POST['description'] ?? '' ?></textarea></li>

            <li><label for="form-post-content">Вміст<span>*</span></label></li>
            <li><textarea name="content" id="form-post-content" required placeholder="Введіть вміст"><?= $_POST['content'] ?? '' ?></textarea></li>

            <li><label for="form-post-publish-date">Дата публікації<span>*</span></label></li>
            <li><input type="datetime-local" value="<?= $_POST['publish_date'] ?? '' ?>" name="publish_date" id="form-post-publish-date" required></li>
